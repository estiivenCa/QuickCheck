...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-06-2024 a las 00:53:56
...
CREATE TABLE `clases` (
  ...
  `telefono_instructor` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `recordatorio` (
  ...
  `FechaRocordatorio` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `recordatorio`
  ADD CONSTRAINT `recordatorio_ibfk_1` FOREIGN KEY (`IdRecordatorio`) REFERENCES `usuario` (`IdUsuario`);

--
-- Filtros para la tabla `rol`
--
ALTER TABLE `rol`
  ADD CONSTRAINT `rol_ibfk_1` FOREIGN KEY (`IdRol`) REFERENCES `usuario` (`IdUsuario`);
